...
| 2.6            | Calculation Logic                  | `CheckDialysateLevel`                 | reduceByFlowRate()                                                 |  I6   |
| 3.1            | Display output                     | `Display`                             | createFrame(),createLabel()                                        |       |
| 3.2            | hardwareAbstraction, Calculation Logic, Display output    | `DialysateSimulator`,`CheckDialysateTemeprature` ,`Display`      | createFrame(),createLabel(),simulateTemperature(),checkDialysateTemperature()  |    M4, M6  |
