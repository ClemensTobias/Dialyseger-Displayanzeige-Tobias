...
| M7 | ArterialPressureGenerator | Der Buffer ist leer | addValue() wird 10-mal aufgerufen | Die letzten 10 Werte werden gespeichert | Buffer enthält genau 10 Werte | ✅ |
| M8 | ArterialPressureGenerator |  Buffer enthält bereits 10 Werte | addValue(120) wird aufgerufen | Der älteste Wert wird entfernt, neuer Wert hinzugefügt | Buffer enthält weiterhin 10 Werte, letzter Wert = 130 | ✅ |
| M9 | CheckDialysateTemperature | DialysateSimulator.temperature = 41 | checkDialysateTemperature() wird aufgerufen  | dialysateTemperatureWarning wird true gesetzt | interner Status dialysateTemperatureWarning = true | ✅ |
...
| I7 | ArterialPressureSimulator, Display | Simulator und Display existieren, Buffer ist leer | 10 Druckwerte werden generiert und gespeichert | Display-Liniendiagramm zeigt die letzten 10 arteriellen Druckwerte | Diagramm und Buffer sind synchron | ✅ |
| I8 | VenousPressureSimulator, Display | Simulator liefert kontinuierlich Werte über 10 Sekunden | Display aktualisiert das Venöse-Druck-Diagramm | Liniendiagramm zeigt Verlauf der letzten 10 Sekunden | Diagramm wird fortlaufend aktualisiert | ✅ |
| I9 | CheckDialysateLevel, Display | Dialysate-Level ist <2 | checkDialysateLevel() wird ausgeführt | DialysateLevelWarning wird aktiviert und im Display angezeigt | Warnstatus und Anzeige sind konsistent  | ✅ |
